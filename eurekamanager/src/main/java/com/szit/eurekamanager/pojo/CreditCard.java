...
public class CreditCard implements Serializable {
    ...
    private BaseInfo baseInfo;//基本信息对象
    private UnitInfo unitInfo;//单位实体对象
    private ContactInfo contactInfo;//联系人对象
    private ChangePeriods changePeriods;//分期对象
    private Question question;//安全问题对象
    ...
    public CreditCard() {
        ...
        changePeriods = new ChangePeriods();
        question = new Question();
        transaction = new Transaction();
        overdue = new Overdue();
    }

    public CreditCard(Integer id, String cardNum, Integer cardType, Double creditLimit, Double useableLimit, Double alreadyLimit, Double overdueAmount, Double changeLimit, Integer outDate, Integer inDate, Integer payPassword, String currency, String openDate, Integer userId, Integer cardStatusId, User user, CardStatus cardStatus, BaseInfo baseInfo, UnitInfo unitInfo, ContactInfo contactInfo,ChangePeriods changePeriods,Question question,Transaction transaction,Overdue overdue) {
        this.id = id;
