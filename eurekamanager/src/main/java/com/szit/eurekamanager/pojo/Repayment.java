...
public class Repayment implements Serializable {
    ...
    public Repayment(Integer id, Double rmoney, Date duedate, Integer debitCardId, Integer cardId, Integer changePeriodsId, CreditCard creditCard, ChangePeriods changePeriods, DebitCard debitCard, BaseInfo baseInfo) {
        this.id = id;
        this.rmoney = rmoney;
