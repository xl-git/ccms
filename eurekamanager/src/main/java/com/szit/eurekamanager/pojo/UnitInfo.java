...
public class UnitInfo implements Serializable {
    ...
    public UnitInfo(Integer id, String companyName, String companyTpe, String unitIphone, String unitAddress, Integer yearIncome, String duty, String unitMail, Integer userId, User user) {
        this.id = id;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, companyName, companyTpe, unitIphone, unitAddress, yearIncome, duty, unitMail, userId, user);
    }
