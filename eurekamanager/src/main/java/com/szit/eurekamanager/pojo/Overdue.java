...
public class Overdue implements Serializable {
    ...
    private Double overdueAmounts;//--逾期金额
    ...
    public Overdue(Integer id, Double overdueAmounts, Date overdueDate, Double overdueRate, Integer count, Integer cardId, CreditCard creditCard) {
        this.id = id;
    ...
    public void setOverdueAmounts(Double overdueAmount) {
        this.overdueAmounts = overdueAmount;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, overdue.id) &&
                Objects.equals(overdueAmounts, overdue.overdueAmounts) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, overdueAmounts, overdueDate, overdueRate, count, cardId, creditCard);
    }
