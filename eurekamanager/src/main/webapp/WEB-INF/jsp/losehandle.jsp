...
<body>
	<div>
		<div class="search">
			<form method="post" action="${pageContext.request.contextPath }/findlose.html">
			...
			<table cellpadding="0" cellspacing="0" border="1" style="text-align: center" >
				...
				<c:forEach var="card" items="${cards}" varStatus="status">
					<tr>
						...
						<td>
							<a href="/manager/lossing.html?cardNum=${card.cardNum}&phone=${card.baseInfo.iphoneNum}&identityCard=${card.baseInfo.identityCard}">
								<input type="button" class="lossing" value="挂失" ></a>
							<a href="/manager/relievelose.html?cardNum=${card.cardNum}&identityCard=${card.baseInfo.identityCard}">
								<input type="button" class="relievelose" value="解除挂失"></a>
						</td>
					</tr>
				</c:forEach>
			</table>
