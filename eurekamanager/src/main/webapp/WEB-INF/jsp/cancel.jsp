...
<body>
<div>
    <form action="/manager/findcancel.html" method="post">
        <div>
            ...
            <table cellpadding="0" cellspacing="0" border="1" style="text-align: center" >
                ...
                <c:forEach var="card" items="${cards}" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <a href="/manager/canceling.html?cardNum=${card.cardNum}&phone=${card.baseInfo.iphoneNum}&identityCard=${card.baseInfo.identityCard}">
                                <input type="button" class="lossing" value="销户" ></a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
